...
{
    /// <inheritdoc />
    public class OrgRulesJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.GitHub.OrgRules>
    {
        /// <inheritdoc />
        public override global::tryAGI.GitHub.OrgRules Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("parameters.required_deployment_environments")) __score4++;
            if (__jsonProps.Contains("type")) __score4++;
            var __score5 = 0;
            if (__jsonProps.Contains("type")) __score5++;
            var __score6 = 0;
            if (__jsonProps.Contains("parameters")) __score6++;
            if (__jsonProps.Contains("parameters.allowed_merge_methods")) __score6++;
            if (__jsonProps.Contains("parameters.dismiss_stale_reviews_on_push")) __score6++;
            if (__jsonProps.Contains("parameters.dismissal_restriction")) __score6++;
            if (__jsonProps.Contains("parameters.require_code_owner_review")) __score6++;
            if (__jsonProps.Contains("parameters.require_last_push_approval")) __score6++;
            if (__jsonProps.Contains("parameters.required_approving_review_count")) __score6++;
            if (__jsonProps.Contains("parameters.required_review_thread_resolution")) __score6++;
            if (__jsonProps.Contains("parameters.required_reviewers")) __score6++;
            if (__jsonProps.Contains("type")) __score6++;
            var __score7 = 0;
            if (__jsonProps.Contains("parameters")) __score7++;
            if (__jsonProps.Contains("parameters.do_not_enforce_on_create")) __score7++;
            if (__jsonProps.Contains("parameters.required_status_checks")) __score7++;
            if (__jsonProps.Contains("parameters.strict_required_status_checks_policy")) __score7++;
            if (__jsonProps.Contains("type")) __score7++;
            var __score8 = 0;
            if (__jsonProps.Contains("type")) __score8++;
            var __score9 = 0;
            if (__jsonProps.Contains("parameters")) __score9++;
            if (__jsonProps.Contains("parameters.name")) __score9++;
            if (__jsonProps.Contains("parameters.negate")) __score9++;
            if (__jsonProps.Contains("parameters.operator")) __score9++;
            if (__jsonProps.Contains("parameters.pattern")) __score9++;
            ...
            if (__jsonProps.Contains("parameters.restricted_file_paths")) __score14++;
            if (__jsonProps.Contains("type")) __score14++;
            var __score15 = 0;
            if (__jsonProps.Contains("parameters")) __score15++;
            if (__jsonProps.Contains("parameters.max_file_path_length")) __score15++;
            if (__jsonProps.Contains("type")) __score15++;
            var __score16 = 0;
            if (__jsonProps.Contains("parameters")) __score16++;
            if (__jsonProps.Contains("parameters.restricted_file_extensions")) __score16++;
            if (__jsonProps.Contains("type")) __score16++;
            var __score17 = 0;
            if (__jsonProps.Contains("parameters")) __score17++;
            if (__jsonProps.Contains("parameters.max_file_size")) __score17++;
            if (__jsonProps.Contains("type")) __score17++;
            var __score18 = 0;
            if (__jsonProps.Contains("parameters")) __score18++;
            if (__jsonProps.Contains("parameters.do_not_enforce_on_create")) __score18++;
            if (__jsonProps.Contains("parameters.workflows")) __score18++;
            if (__jsonProps.Contains("type")) __score18++;
            var __score19 = 0;
            if (__jsonProps.Contains("parameters")) __score19++;
            if (__jsonProps.Contains("parameters.code_scanning_tools")) __score19++;
            if (__jsonProps.Contains("type")) __score19++;
            var __score20 = 0;
            if (__jsonProps.Contains("parameters")) __score20++;
            if (__jsonProps.Contains("parameters.review_draft_pull_requests")) __score20++;
            if (__jsonProps.Contains("parameters.review_on_push")) __score20++;
            ...
            var __value = new global::tryAGI.GitHub.OrgRules(
                creation,
        ...
        public override void Write(
            ...
            global::tryAGI.GitHub.OrgRules value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
