...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareSecretScanningBulkCreateRepoCustomPatternsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            global::tryAGI.GitHub.SecretScanningBulkCreateRepoCustomPatternsRequest request);
        partial void PrepareSecretScanningBulkCreateRepoCustomPatternsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string owner,
            string repo,
            global::tryAGI.GitHub.SecretScanningBulkCreateRepoCustomPatternsRequest request);
        partial void ProcessSecretScanningBulkCreateRepoCustomPatternsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSecretScanningBulkCreateRepoCustomPatternsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.SecretScanningBulkCreateRepoCustomPatternsResponse> SecretScanningBulkCreateRepoCustomPatternsAsync(
            string owner,
            string repo,
        ...
        {
            var __response = await SecretScanningBulkCreateRepoCustomPatternsAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.SecretScanningBulkCreateRepoCustomPatternsResponse>> SecretScanningBulkCreateRepoCustomPatternsAsResponseAsync(
            string owner,
            string repo,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSecretScanningBulkCreateRepoCustomPatternsArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSecretScanningBulkCreateRepoCustomPatternsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SecretScanningBulkCreateRepoCustomPatternsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSecretScanningBulkCreateRepoCustomPatternsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                global::tryAGI.GitHub.SecretScanningBulkCreateRepoCustomPatternsResponse2? __value_422 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_422 = global::tryAGI.GitHub.SecretScanningBulkCreateRepoCustomPatternsResponse2.FromJson(__content_422, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.SecretScanningBulkCreateRepoCustomPatternsResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSecretScanningBulkCreateRepoCustomPatternsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.SecretScanningBulkCreateRepoCustomPatternsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.SecretScanningBulkCreateRepoCustomPatternsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.SecretScanningBulkCreateRepoCustomPatternsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.SecretScanningBulkCreateRepoCustomPatternsResponse> SecretScanningBulkCreateRepoCustomPatternsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.SecretScanningBulkCreateRepoCustomPatternsRequest
            {
                Patterns = patterns,
            };

            return await SecretScanningBulkCreateRepoCustomPatternsAsync(
                owner: owner,
                repo: repo,
                request: __request,
                requestOptions: requestOptions,
