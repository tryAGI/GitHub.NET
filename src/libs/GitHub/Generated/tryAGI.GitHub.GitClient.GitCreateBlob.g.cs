...
namespace tryAGI.GitHub
{
    public partial class GitClient
    {
        partial void PrepareGitCreateBlobArguments(
            ...
            ref string owner,
            ref string repo,
            global::tryAGI.GitHub.GitCreateBlobRequest request);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.ShortBlob> GitCreateBlobAsync(
            string owner,
            string repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.ShortBlob>> GitCreateBlobAsResponseAsync(
            string owner,
            string repo,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                global::tryAGI.GitHub.OneOf<global::tryAGI.GitHub.ValidationError, global::tryAGI.GitHub.RepositoryRuleViolationError>? __value_422 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_422 = global::tryAGI.GitHub.OneOf<global::tryAGI.GitHub.ValidationError, global::tryAGI.GitHub.RepositoryRuleViolationError>.FromJson(__content_422, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.OneOf<global::tryAGI.GitHub.ValidationError, global::tryAGI.GitHub.RepositoryRuleViolationError>?>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.ShortBlob.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.ShortBlob>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.ShortBlob.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.ShortBlob> GitCreateBlobAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.GitCreateBlobRequest
            {
                Content = content,
                Encoding = encoding,
            };
