...
namespace tryAGI.GitHub
{
    public partial class ProjectsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.ProjectsV2ItemWithContent> ProjectsGetUserItemAsync(
            int projectNumber,
            string username,
            int itemId,
        ...
        {
            var __response = await ProjectsGetUserItemAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.ProjectsV2ItemWithContent>> ProjectsGetUserItemAsResponseAsync(
            int projectNumber,
            string username,
            int itemId,
            global::tryAGI.GitHub.OneOf<string, global::System.Collections.Generic.IList<string>>? fields = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ProjectsGetUserItemAsync",
                                pathTemplate: "$\"/users/{username}/projectsV2/{projectNumber}/items/{itemId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.ProjectsV2ItemWithContent.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.ProjectsV2ItemWithContent>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.ProjectsV2ItemWithContent.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
