...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareIssuesDeleteIssueFieldValueArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            ref int issueNumber,
            ref int issueFieldId);
        partial void PrepareIssuesDeleteIssueFieldValueRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int issueNumber,
            int issueFieldId);
        partial void ProcessIssuesDeleteIssueFieldValueResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task IssuesDeleteIssueFieldValueAsync(
            string owner,
            string repo,
            int issueNumber,
            int issueFieldId,
        ...
        {
            await IssuesDeleteIssueFieldValueAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse> IssuesDeleteIssueFieldValueAsResponseAsync(
            string owner,
            string repo,
            int issueNumber,
            int issueFieldId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareIssuesDeleteIssueFieldValueArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareIssuesDeleteIssueFieldValueRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "IssuesDeleteIssueFieldValueAsync",
                                pathTemplate: "$\"/repos/{owner}/{repo}/issues/{issueNumber}/issue-field-values/{issueFieldId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessIssuesDeleteIssueFieldValueResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                global::tryAGI.GitHub.IssuesDeleteIssueFieldValueResponse? __value_503 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_503 = global::tryAGI.GitHub.IssuesDeleteIssueFieldValueResponse.FromJson(__content_503, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.IssuesDeleteIssueFieldValueResponse>.Create(
                                    statusCode: __response.StatusCode,
