...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareProjectsCreateViewForOrgArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string org,
            ref int projectNumber,
            global::tryAGI.GitHub.ProjectsCreateViewForOrgRequest request);
        partial void PrepareProjectsCreateViewForOrgRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string org,
            int projectNumber,
            global::tryAGI.GitHub.ProjectsCreateViewForOrgRequest request);
        partial void ProcessProjectsCreateViewForOrgResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectsCreateViewForOrgResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.ProjectsV2View> ProjectsCreateViewForOrgAsync(
            string org,
            int projectNumber,
        ...
        {
            var __response = await ProjectsCreateViewForOrgAsResponseAsync(
                org: org,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.ProjectsV2View>> ProjectsCreateViewForOrgAsResponseAsync(
            string org,
            int projectNumber,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareProjectsCreateViewForOrgArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareProjectsCreateViewForOrgRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ProjectsCreateViewForOrgAsync",
                                pathTemplate: "$\"/orgs/{org}/projectsV2/{projectNumber}/views\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessProjectsCreateViewForOrgResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProjectsCreateViewForOrgResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.ProjectsV2View> ProjectsCreateViewForOrgAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.ProjectsCreateViewForOrgRequest
            {
                Name = name,
                Layout = layout,
                Filter = filter,
            ...
            return await ProjectsCreateViewForOrgAsync(
                org: org,
                projectNumber: projectNumber,
                request: __request,
                requestOptions: requestOptions,
