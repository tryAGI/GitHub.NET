...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareDependencyGraphFetchSbomReportArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            ref string sbomUuid);
        partial void PrepareDependencyGraphFetchSbomReportRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string owner,
            string repo,
            string sbomUuid);
        partial void ProcessDependencyGraphFetchSbomReportResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task DependencyGraphFetchSbomReportAsync(
            string owner,
            string repo,
            string sbomUuid,
        ...
        {
            await DependencyGraphFetchSbomReportAsResponseAsync(
                owner: owner,
                repo: repo,
                sbomUuid: sbomUuid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse> DependencyGraphFetchSbomReportAsResponseAsync(
            string owner,
            string repo,
            string sbomUuid,
            global::tryAGI.GitHub.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDependencyGraphFetchSbomReportArguments(
                httpClient: HttpClient,
                owner: ref owner,
                repo: ref repo,
                sbomUuid: ref sbomUuid);
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDependencyGraphFetchSbomReportRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DependencyGraphFetchSbomReportAsync",
                                pathTemplate: "$\"/repos/{owner}/{repo}/dependency-graph/sbom/fetch-report/{sbomUuid}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDependencyGraphFetchSbomReportResponse(
                    httpClient: HttpClient,
