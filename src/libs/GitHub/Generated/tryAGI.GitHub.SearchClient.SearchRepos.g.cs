...
namespace tryAGI.GitHub
{
    public partial class SearchClient
    {
        partial void PrepareSearchReposArguments(
            ...
            ref string q,
            ref global::tryAGI.GitHub.SearchReposSort? sort,
            ref global::tryAGI.GitHub.SearchReposOrder? order,
            ref int? perPage,
            ref int? page);
        partial void PrepareSearchReposRequest(
            ...
            string q,
            global::tryAGI.GitHub.SearchReposSort? sort,
            global::tryAGI.GitHub.SearchReposOrder? order,
            int? perPage,
            int? page);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.SearchReposResponse> SearchReposAsync(
            string q,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.SearchReposResponse>> SearchReposAsResponseAsync(
            string q,
            global::tryAGI.GitHub.SearchReposSort? sort = default,
            global::tryAGI.GitHub.SearchReposOrder? order = default,
            int? perPage = default,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                global::tryAGI.GitHub.SearchReposResponse2? __value_503 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_503 = global::tryAGI.GitHub.SearchReposResponse2.FromJson(__content_503, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.SearchReposResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.SearchReposResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.SearchReposResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.SearchReposResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::tryAGI.GitHub.RepoSearchResultItem> SearchReposAutoPagingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::tryAGI.GitHub.AutoSDKPager.OffsetAsync<global::tryAGI.GitHub.SearchReposResponse, global::tryAGI.GitHub.RepoSearchResultItem>(
                fetchPage: (__page, __ct) => SearchReposAsync(
                    q: q,
                    sort: sort,
                    order: order,
                    perPage: perPage,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::tryAGI.GitHub.RepoSearchResultItem>?)__response.Items,
                initialPage: page ?? 1,
                cancellationToken: cancellationToken);
        }
