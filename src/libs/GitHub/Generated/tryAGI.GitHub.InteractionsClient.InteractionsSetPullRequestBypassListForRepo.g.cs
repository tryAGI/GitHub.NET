...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareInteractionsSetPullRequestBypassListForRepoArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            global::tryAGI.GitHub.InteractionLimitPullRequestBypassList request);
        partial void PrepareInteractionsSetPullRequestBypassListForRepoRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string owner,
            string repo,
            global::tryAGI.GitHub.InteractionLimitPullRequestBypassList request);
        partial void ProcessInteractionsSetPullRequestBypassListForRepoResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task InteractionsSetPullRequestBypassListForRepoAsync(
            string owner,
            string repo,
        ...
        {
            await InteractionsSetPullRequestBypassListForRepoAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse> InteractionsSetPullRequestBypassListForRepoAsResponseAsync(
            string owner,
            string repo,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareInteractionsSetPullRequestBypassListForRepoArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareInteractionsSetPullRequestBypassListForRepoRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "InteractionsSetPullRequestBypassListForRepo",
                                methodName: "InteractionsSetPullRequestBypassListForRepoAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessInteractionsSetPullRequestBypassListForRepoResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task InteractionsSetPullRequestBypassListForRepoAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.InteractionLimitPullRequestBypassList
            {
                Users = users,
            };

            await InteractionsSetPullRequestBypassListForRepoAsync(
                owner: owner,
                repo: repo,
                request: __request,
                requestOptions: requestOptions,
