...
namespace tryAGI.GitHub
{
    public partial interface ISecurityAdvisoriesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<string>> SecurityAdvisoriesCreateRepositoryAdvisoryCveRequestAsResponseAsync(
            string owner,
            string repo,
            string ghsaId,
            global::tryAGI.GitHub.AutoSDKRequestOptions? requestOptions = default,
