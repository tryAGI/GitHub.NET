...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareInteractionsUpdatePullRequestCreationCapForOrgArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string org,
            global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForOrgRequest request);
        partial void PrepareInteractionsUpdatePullRequestCreationCapForOrgRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string org,
            global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForOrgRequest request);
        partial void ProcessInteractionsUpdatePullRequestCreationCapForOrgResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessInteractionsUpdatePullRequestCreationCapForOrgResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForOrgResponse> InteractionsUpdatePullRequestCreationCapForOrgAsync(
            string org,
        ...
        {
            var __response = await InteractionsUpdatePullRequestCreationCapForOrgAsResponseAsync(
                org: org,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForOrgResponse>> InteractionsUpdatePullRequestCreationCapForOrgAsResponseAsync(
            string org,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareInteractionsUpdatePullRequestCreationCapForOrgArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareInteractionsUpdatePullRequestCreationCapForOrgRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "InteractionsUpdatePullRequestCreationCapForOrgAsync",
                                pathTemplate: "$\"/orgs/{org}/interaction-limits/pulls/creation-cap\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessInteractionsUpdatePullRequestCreationCapForOrgResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessInteractionsUpdatePullRequestCreationCapForOrgResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForOrgResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForOrgResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForOrgResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForOrgResponse> InteractionsUpdatePullRequestCreationCapForOrgAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForOrgRequest
            {
                Enabled = enabled,
                MaxOpenPullRequests = maxOpenPullRequests,
            };

            return await InteractionsUpdatePullRequestCreationCapForOrgAsync(
                org: org,
                request: __request,
                requestOptions: requestOptions,
