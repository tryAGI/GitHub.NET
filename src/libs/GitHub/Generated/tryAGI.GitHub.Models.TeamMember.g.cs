...
namespace tryAGI.GitHub
{
    ...
    public sealed partial class TeamMember
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::tryAGI.GitHub.JsonConverters.TeamMemberRoleJsonConverter))]
        public global::tryAGI.GitHub.TeamMemberRole? Role { get; set; }

        /// <summary>
        /// Whether the user is a member of the team only through a child team. `true` means the membership is inherited from a child team; `false` means the user is a direct (immediate) member of the team. Only present on the `List team members` endpoint, and only when the feature is enabled for the organization.<br/>
        /// Example: false
        /// </summary>
        ...
        public TeamMember(
            ...
            string? starredAt,
            string? userViewType,
            global::tryAGI.GitHub.TeamMemberRole? role,
            bool? inherited)
        {
            this.Name = name;
            this.Email = email;
