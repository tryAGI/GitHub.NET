...
namespace tryAGI.GitHub
{
    public partial class CodespacesClient
    {
        partial void PrepareCodespacesCreateWithRepoForAuthenticatedUserArguments(
            ...
            ref string owner,
            ref string repo,
            global::tryAGI.GitHub.CodespacesCreateWithRepoForAuthenticatedUserRequest request);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.Codespace> CodespacesCreateWithRepoForAuthenticatedUserAsync(
            string owner,
            string repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.Codespace>> CodespacesCreateWithRepoForAuthenticatedUserAsResponseAsync(
            string owner,
            string repo,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                global::tryAGI.GitHub.CodespacesCreateWithRepoForAuthenticatedUserResponse? __value_503 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_503 = global::tryAGI.GitHub.CodespacesCreateWithRepoForAuthenticatedUserResponse.FromJson(__content_503, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.CodespacesCreateWithRepoForAuthenticatedUserResponse>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.Codespace.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.Codespace>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.Codespace.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.Codespace> CodespacesCreateWithRepoForAuthenticatedUserAsync(
            ...
            global::tryAGI.GitHub.CodespacesCreateWithRepoForAuthenticatedUserRequestGeo? geo = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.CodespacesCreateWithRepoForAuthenticatedUserRequest
            {
                Ref = @ref,
                Location = location,
                Geo = geo,
