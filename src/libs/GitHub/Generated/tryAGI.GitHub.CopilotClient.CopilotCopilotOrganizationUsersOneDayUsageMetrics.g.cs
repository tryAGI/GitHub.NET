...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareCopilotCopilotOrganizationUsersOneDayUsageMetricsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string org,
            ref global::System.DateTime day);
        partial void PrepareCopilotCopilotOrganizationUsersOneDayUsageMetricsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string org,
            global::System.DateTime day);
        partial void ProcessCopilotCopilotOrganizationUsersOneDayUsageMetricsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCopilotCopilotOrganizationUsersOneDayUsageMetricsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get Copilot organization users usage metrics for a specific day<br/>
        /// Use this endpoint to retrieve download links for the Copilot organization user usage metrics report for a specific day. The report provides detailed user-level usage data and engagement metrics for Copilot features across the organization.<br/>
        ...
        /// Reports are generated daily and made available for download through signed URLs with a limited expiration time. The response includes download links to the report files, along with the specific date of the report. The report covers a complete day for which data has been processed.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.CopilotUsageMetrics1DayReport> CopilotCopilotOrganizationUsersOneDayUsageMetricsAsync(
            string org,
            global::System.DateTime day,
            global::tryAGI.GitHub.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CopilotCopilotOrganizationUsersOneDayUsageMetricsAsResponseAsync(
                org: org,
                day: day,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.CopilotUsageMetrics1DayReport>> CopilotCopilotOrganizationUsersOneDayUsageMetricsAsResponseAsync(
            string org,
            global::System.DateTime day,
            global::tryAGI.GitHub.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCopilotCopilotOrganizationUsersOneDayUsageMetricsArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCopilotCopilotOrganizationUsersOneDayUsageMetricsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CopilotCopilotOrganizationUsersOneDayUsageMetricsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCopilotCopilotOrganizationUsersOneDayUsageMetricsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCopilotCopilotOrganizationUsersOneDayUsageMetricsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
