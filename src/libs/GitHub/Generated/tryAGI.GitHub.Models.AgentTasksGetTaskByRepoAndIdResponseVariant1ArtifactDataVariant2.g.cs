...
namespace tryAGI.GitHub
{
    ...
    public sealed partial class AgentTasksGetTaskByRepoAndIdResponseVariant1ArtifactDataVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentTasksGetTaskByRepoAndIdResponseVariant1ArtifactDataVariant2" /> class.
        /// </summary>
        /// <param name="headRef">
        /// Head branch name
        /// </param>
...
#endif
        public AgentTasksGetTaskByRepoAndIdResponseVariant1ArtifactDataVariant2(
            string headRef,
            string baseRef)
        {
