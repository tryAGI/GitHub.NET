...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareBillingGetGithubBillingAiCreditUsageReportUserArguments(
            ...
            ref string? model,
            ref string? product);
        partial void PrepareBillingGetGithubBillingAiCreditUsageReportUserRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? model,
            string? product);
        partial void ProcessBillingGetGithubBillingAiCreditUsageReportUserResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBillingGetGithubBillingAiCreditUsageReportUserResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.BillingAiCreditUsageReportUser> BillingGetGithubBillingAiCreditUsageReportUserAsync(
            string username,
            int? year = default,
            int? month = default,
            int? day = default,
        ...
        {
            var __response = await BillingGetGithubBillingAiCreditUsageReportUserAsResponseAsync(
                username: username,
                year: year,
                month: month,
                day: day,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.BillingAiCreditUsageReportUser>> BillingGetGithubBillingAiCreditUsageReportUserAsResponseAsync(
            string username,
            int? year = default,
            int? month = default,
            int? day = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBillingGetGithubBillingAiCreditUsageReportUserArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBillingGetGithubBillingAiCreditUsageReportUserRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BillingGetGithubBillingAiCreditUsageReportUserAsync",
                                pathTemplate: "$\"/users/{username}/settings/billing/ai_credit/usage\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBillingGetGithubBillingAiCreditUsageReportUserResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                global::tryAGI.GitHub.BillingGetGithubBillingAiCreditUsageReportUserResponse? __value_503 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_503 = global::tryAGI.GitHub.BillingGetGithubBillingAiCreditUsageReportUserResponse.FromJson(__content_503, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.BillingGetGithubBillingAiCreditUsageReportUserResponse>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBillingGetGithubBillingAiCreditUsageReportUserResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.BillingAiCreditUsageReportUser.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.BillingAiCreditUsageReportUser>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.BillingAiCreditUsageReportUser.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
