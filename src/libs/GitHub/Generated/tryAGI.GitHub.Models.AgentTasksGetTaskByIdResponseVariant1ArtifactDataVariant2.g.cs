...
namespace tryAGI.GitHub
{
    ...
    public sealed partial class AgentTasksGetTaskByIdResponseVariant1ArtifactDataVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentTasksGetTaskByIdResponseVariant1ArtifactDataVariant2" /> class.
        /// </summary>
        /// <param name="headRef">
        /// Head branch name
        /// </param>
...
#endif
        public AgentTasksGetTaskByIdResponseVariant1ArtifactDataVariant2(
            string headRef,
            string baseRef)
        {
