...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareCopilotCopilotEnterpriseOneDayUsageMetricsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string enterprise,
            ref global::System.DateTime day);
        partial void PrepareCopilotCopilotEnterpriseOneDayUsageMetricsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string enterprise,
            global::System.DateTime day);
        partial void ProcessCopilotCopilotEnterpriseOneDayUsageMetricsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCopilotCopilotEnterpriseOneDayUsageMetricsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get Copilot enterprise usage metrics for a specific day<br/>
        /// Use this endpoint to retrieve download links for the Copilot enterprise usage metrics report for a specific day. The report provides comprehensive usage data for Copilot features across the enterprise.<br/>
        /// The report contains aggregated metrics for the specified day, including usage statistics for various Copilot features, user engagement data, and feature adoption metrics. Reports are generated daily and made available for download through signed URLs with a limited expiration time.<br/>
        /// The response includes download links to the report files, along with the specific date of the report. The report covers a complete day for which data has been processed. Reports are available starting from October 10, 2025, and historical data can be accessed for up to 1 year from the current date.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.CopilotUsageMetrics1DayReport> CopilotCopilotEnterpriseOneDayUsageMetricsAsync(
            string enterprise,
            global::System.DateTime day,
            global::tryAGI.GitHub.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CopilotCopilotEnterpriseOneDayUsageMetricsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.CopilotUsageMetrics1DayReport>> CopilotCopilotEnterpriseOneDayUsageMetricsAsResponseAsync(
            string enterprise,
            global::System.DateTime day,
            global::tryAGI.GitHub.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCopilotCopilotEnterpriseOneDayUsageMetricsArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddRequiredParameter("day", day.ToString("yyyy-MM-dd"))
                                ;
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCopilotCopilotEnterpriseOneDayUsageMetricsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CopilotCopilotEnterpriseOneDayUsageMetricsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCopilotCopilotEnterpriseOneDayUsageMetricsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCopilotCopilotEnterpriseOneDayUsageMetricsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.CopilotUsageMetrics1DayReport.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.CopilotUsageMetrics1DayReport>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.CopilotUsageMetrics1DayReport.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
