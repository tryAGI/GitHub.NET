...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareAgentsUpdateRepoVariableArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            ref string name,
            global::tryAGI.GitHub.AgentsUpdateRepoVariableRequest request);
        partial void PrepareAgentsUpdateRepoVariableRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string name,
            global::tryAGI.GitHub.AgentsUpdateRepoVariableRequest request);
        partial void ProcessAgentsUpdateRepoVariableResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task AgentsUpdateRepoVariableAsync(
            string owner,
            string repo,
            string name,
        ...
        {
            await AgentsUpdateRepoVariableAsResponseAsync(
                owner: owner,
                repo: repo,
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse> AgentsUpdateRepoVariableAsResponseAsync(
            string owner,
            string repo,
            string name,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAgentsUpdateRepoVariableArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAgentsUpdateRepoVariableRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AgentsUpdateRepoVariableAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAgentsUpdateRepoVariableResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task AgentsUpdateRepoVariableAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.AgentsUpdateRepoVariableRequest
            {
                Name = requestName,
                Value = value,
            };

            await AgentsUpdateRepoVariableAsync(
                owner: owner,
                repo: repo,
                name: name,
                request: __request,
