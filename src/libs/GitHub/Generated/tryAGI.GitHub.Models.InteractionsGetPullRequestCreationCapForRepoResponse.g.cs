...
namespace tryAGI.GitHub
{
    ...
    public sealed partial class InteractionsGetPullRequestCreationCapForRepoResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InteractionsGetPullRequestCreationCapForRepoResponse" /> class.
        /// </summary>
        /// <param name="enabled">
        /// Whether the pull request creation cap is enabled
        /// </param>
...
#endif
        public InteractionsGetPullRequestCreationCapForRepoResponse(
            bool enabled,
