...
namespace tryAGI.GitHub
{
    public partial class CodeScanningClient
    {
        ...
        /// Gets the status and description of an autofix for a code scanning alert on the repository's default branch.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.CodeScanningAutofix> CodeScanningGetAutofixAsync(
            string owner,
            string repo,
            int alertNumber,
        ...
        {
            var __response = await CodeScanningGetAutofixAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.CodeScanningAutofix>> CodeScanningGetAutofixAsResponseAsync(
            string owner,
            string repo,
            int alertNumber,
            global::tryAGI.GitHub.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CodeScanningGetAutofixAsync",
                                pathTemplate: "$\"/repos/{owner}/{repo}/code-scanning/alerts/{alertNumber}/autofix\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.CodeScanningAutofix.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.CodeScanningAutofix>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.CodeScanningAutofix.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
