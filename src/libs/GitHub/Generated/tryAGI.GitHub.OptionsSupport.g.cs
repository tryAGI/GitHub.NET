...
namespace tryAGI.GitHub
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::tryAGI.GitHub.AutoSDKRetryOptions Retry { get; set; } = new global::tryAGI.GitHub.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::tryAGI.GitHub.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::tryAGI.GitHub.IAutoSDKHook>();
        ...
        public global::tryAGI.GitHub.AutoSDKClientOptions AddHook(
            global::tryAGI.GitHub.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::tryAGI.GitHub.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::tryAGI.GitHub.AutoSDKClientOptions UseAuthorizationProvider(
            global::tryAGI.GitHub.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::tryAGI.GitHub.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::tryAGI.GitHub.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::tryAGI.GitHub.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::tryAGI.GitHub.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::tryAGI.GitHub.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::tryAGI.GitHub.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::tryAGI.GitHub.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::tryAGI.GitHub.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::tryAGI.GitHub.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::tryAGI.GitHub.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::tryAGI.GitHub.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::tryAGI.GitHub.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::tryAGI.GitHub.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::tryAGI.GitHub.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::tryAGI.GitHub.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::tryAGI.GitHub.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::tryAGI.GitHub.AutoSDKClientOptions clientOptions,
            global::tryAGI.GitHub.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::tryAGI.GitHub.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::tryAGI.GitHub.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::tryAGI.GitHub.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::tryAGI.GitHub.AutoSDKClientOptions clientOptions,
            global::System.Func<global::tryAGI.GitHub.IAutoSDKHook, global::tryAGI.GitHub.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::tryAGI.GitHub.AutoSDKHookContext context)
        {
