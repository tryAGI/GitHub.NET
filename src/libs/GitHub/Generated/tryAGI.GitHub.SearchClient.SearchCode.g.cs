...
namespace tryAGI.GitHub
{
    public partial class SearchClient
    {
        partial void PrepareSearchCodeArguments(
            ...
            ref string q,
            ref global::tryAGI.GitHub.SearchCodeSort? sort,
            ref global::tryAGI.GitHub.SearchCodeOrder? order,
            ref int? perPage,
            ref int? page);
        partial void PrepareSearchCodeRequest(
            ...
            string q,
            global::tryAGI.GitHub.SearchCodeSort? sort,
            global::tryAGI.GitHub.SearchCodeOrder? order,
            int? perPage,
            int? page);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.SearchCodeResponse> SearchCodeAsync(
            string q,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.SearchCodeResponse>> SearchCodeAsResponseAsync(
            string q,
            global::tryAGI.GitHub.SearchCodeSort? sort = default,
            global::tryAGI.GitHub.SearchCodeOrder? order = default,
            int? perPage = default,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                global::tryAGI.GitHub.SearchCodeResponse2? __value_503 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_503 = global::tryAGI.GitHub.SearchCodeResponse2.FromJson(__content_503, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.SearchCodeResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.SearchCodeResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.SearchCodeResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.SearchCodeResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::tryAGI.GitHub.CodeSearchResultItem> SearchCodeAutoPagingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::tryAGI.GitHub.AutoSDKPager.OffsetAsync<global::tryAGI.GitHub.SearchCodeResponse, global::tryAGI.GitHub.CodeSearchResultItem>(
                fetchPage: (__page, __ct) => SearchCodeAsync(
                    q: q,
                    sort: sort,
                    order: order,
                    perPage: perPage,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::tryAGI.GitHub.CodeSearchResultItem>?)__response.Items,
                initialPage: page ?? 1,
                cancellationToken: cancellationToken);
        }
