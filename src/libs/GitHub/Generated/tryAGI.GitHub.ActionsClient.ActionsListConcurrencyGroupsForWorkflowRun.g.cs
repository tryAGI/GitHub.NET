...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareActionsListConcurrencyGroupsForWorkflowRunArguments(
            ...
            ref string? before,
            ref string? after);
        partial void PrepareActionsListConcurrencyGroupsForWorkflowRunRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? before,
            string? after);
        partial void ProcessActionsListConcurrencyGroupsForWorkflowRunResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActionsListConcurrencyGroupsForWorkflowRunResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.ConcurrencyGroupRunList> ActionsListConcurrencyGroupsForWorkflowRunAsync(
            string owner,
            string repo,
            int runId,
            int? perPage = default,
        ...
        {
            var __response = await ActionsListConcurrencyGroupsForWorkflowRunAsResponseAsync(
                owner: owner,
                repo: repo,
                runId: runId,
                perPage: perPage,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.ConcurrencyGroupRunList>> ActionsListConcurrencyGroupsForWorkflowRunAsResponseAsync(
            string owner,
            string repo,
            int runId,
            int? perPage = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActionsListConcurrencyGroupsForWorkflowRunArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActionsListConcurrencyGroupsForWorkflowRunRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ActionsListConcurrencyGroupsForWorkflowRunAsync",
                                pathTemplate: "$\"/repos/{owner}/{repo}/actions/runs/{runId}/concurrency_groups\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActionsListConcurrencyGroupsForWorkflowRunResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActionsListConcurrencyGroupsForWorkflowRunResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.ConcurrencyGroupRunList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.ConcurrencyGroupRunList>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.ConcurrencyGroupRunList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
