...
namespace tryAGI.GitHub
{
    public partial class IssuesClient
    {
        partial void PrepareIssuesReprioritizeSubIssueArguments(
            ...
            ref string repo,
            ref int issueNumber,
            global::tryAGI.GitHub.IssuesReprioritizeSubIssueRequest request);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.Issue> IssuesReprioritizeSubIssueAsync(
            string owner,
            string repo,
            int issueNumber,
        ...
        {
            var __response = await IssuesReprioritizeSubIssueAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.Issue>> IssuesReprioritizeSubIssueAsResponseAsync(
            string owner,
            string repo,
            int issueNumber,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "IssuesReprioritizeSubIssueAsync",
                                pathTemplate: "$\"/repos/{owner}/{repo}/issues/{issueNumber}/sub_issues/priority\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                global::tryAGI.GitHub.IssuesReprioritizeSubIssueResponse? __value_503 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_503 = global::tryAGI.GitHub.IssuesReprioritizeSubIssueResponse.FromJson(__content_503, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.IssuesReprioritizeSubIssueResponse>.Create(
                                    statusCode: __response.StatusCode,
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.Issue> IssuesReprioritizeSubIssueAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.IssuesReprioritizeSubIssueRequest
            {
