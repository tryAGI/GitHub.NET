...
namespace tryAGI.GitHub
{
    ...
    public sealed partial class InteractionsGetPullRequestCreationCapForOrgResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InteractionsGetPullRequestCreationCapForOrgResponse" /> class.
        /// </summary>
        /// <param name="enabled">
        /// Whether the pull request creation cap is enabled
        /// </param>
...
#endif
        public InteractionsGetPullRequestCreationCapForOrgResponse(
            bool enabled,
