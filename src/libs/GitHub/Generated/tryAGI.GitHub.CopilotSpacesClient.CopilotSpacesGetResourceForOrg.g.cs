...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareCopilotSpacesGetResourceForOrgArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string org,
            ref int spaceNumber,
            ref int spaceResourceId);
        partial void PrepareCopilotSpacesGetResourceForOrgRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string org,
            int spaceNumber,
            int spaceResourceId);
        partial void ProcessCopilotSpacesGetResourceForOrgResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCopilotSpacesGetResourceForOrgResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.CopilotSpaceResource> CopilotSpacesGetResourceForOrgAsync(
            string org,
            int spaceNumber,
            int spaceResourceId,
        ...
        {
            var __response = await CopilotSpacesGetResourceForOrgAsResponseAsync(
                org: org,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.CopilotSpaceResource>> CopilotSpacesGetResourceForOrgAsResponseAsync(
            string org,
            int spaceNumber,
            int spaceResourceId,
            global::tryAGI.GitHub.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCopilotSpacesGetResourceForOrgArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCopilotSpacesGetResourceForOrgRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CopilotSpacesGetResourceForOrgAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCopilotSpacesGetResourceForOrgResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCopilotSpacesGetResourceForOrgResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
