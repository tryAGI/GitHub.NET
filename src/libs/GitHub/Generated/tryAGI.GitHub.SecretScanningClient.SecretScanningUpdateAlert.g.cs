...
namespace tryAGI.GitHub
{
    public partial class SecretScanningClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.SecretScanningAlertWithMetadata> SecretScanningUpdateAlertAsync(
            string owner,
            string repo,
            int alertNumber,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.SecretScanningAlertWithMetadata>> SecretScanningUpdateAlertAsResponseAsync(
            string owner,
            string repo,
            int alertNumber,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                global::tryAGI.GitHub.SecretScanningUpdateAlertResponse? __value_503 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_503 = global::tryAGI.GitHub.SecretScanningUpdateAlertResponse.FromJson(__content_503, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.SecretScanningUpdateAlertResponse>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.SecretScanningAlertWithMetadata.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.SecretScanningAlertWithMetadata>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.SecretScanningAlertWithMetadata.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.SecretScanningAlertWithMetadata> SecretScanningUpdateAlertAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.SecretScanningUpdateAlertRequest
            {
                State = state,
