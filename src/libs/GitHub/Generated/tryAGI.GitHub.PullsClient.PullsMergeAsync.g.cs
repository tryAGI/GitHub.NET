...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PreparePullsMergeAsyncArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            ref int pullNumber,
            global::tryAGI.GitHub.PullsMergeAsyncRequest request);
        partial void PreparePullsMergeAsyncRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int pullNumber,
            global::tryAGI.GitHub.PullsMergeAsyncRequest request);
        partial void ProcessPullsMergeAsyncResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPullsMergeAsyncResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.PullRequestMergeAsyncResult> PullsMergeAsyncAsync(
            string owner,
            string repo,
            int pullNumber,
        ...
        {
            var __response = await PullsMergeAsyncAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.PullRequestMergeAsyncResult>> PullsMergeAsyncAsResponseAsync(
            string owner,
            string repo,
            int pullNumber,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePullsMergeAsyncArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PullsMergeAsyncAsync",
                                pathTemplate: "$\"/repos/{owner}/{repo}/pulls/{pullNumber}/merge-async\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPullsMergeAsyncResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 409)
                            {
                                ...
                                global::tryAGI.GitHub.PullRequestMergeAsyncResult? __value_409 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_409 = global::tryAGI.GitHub.PullRequestMergeAsyncResult.FromJson(__content_409, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.PullRequestMergeAsyncResult>.Create(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::tryAGI.GitHub.PullRequestMergeAsyncResult? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::tryAGI.GitHub.PullRequestMergeAsyncResult.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPullsMergeAsyncResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.PullRequestMergeAsyncResult> PullsMergeAsyncAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.PullsMergeAsyncRequest
            {
            ...
            return await PullsMergeAsyncAsync(
                owner: owner,
                repo: repo,
                pullNumber: pullNumber,
                request: __request,
