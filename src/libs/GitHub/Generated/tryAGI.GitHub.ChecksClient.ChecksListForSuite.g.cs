...
namespace tryAGI.GitHub
{
    public partial class ChecksClient
    {
        partial void PrepareChecksListForSuiteArguments(
            ...
            ref global::tryAGI.GitHub.ChecksListForSuiteStatus? status,
            ref global::tryAGI.GitHub.ChecksListForSuiteFilter? filter,
            ref int? perPage,
            ref int? page);
        partial void PrepareChecksListForSuiteRequest(
            ...
            int checkSuiteId,
            string? checkName,
            global::tryAGI.GitHub.ChecksListForSuiteStatus? status,
            global::tryAGI.GitHub.ChecksListForSuiteFilter? filter,
            int? perPage,
            int? page);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.ChecksListForSuiteResponse> ChecksListForSuiteAsync(
            string owner,
            string repo,
            int checkSuiteId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.ChecksListForSuiteResponse>> ChecksListForSuiteAsResponseAsync(
            string owner,
            string repo,
            int checkSuiteId,
            string? checkName = default,
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.ChecksListForSuiteResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.ChecksListForSuiteResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.ChecksListForSuiteResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::tryAGI.GitHub.CheckRun> ChecksListForSuiteAutoPagingAsync(
            string owner,
            string repo,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::tryAGI.GitHub.AutoSDKPager.OffsetAsync<global::tryAGI.GitHub.ChecksListForSuiteResponse, global::tryAGI.GitHub.CheckRun>(
                fetchPage: (__page, __ct) => ChecksListForSuiteAsync(
                    owner: owner,
                    repo: repo,
                    checkSuiteId: checkSuiteId,
                    checkName: checkName,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::tryAGI.GitHub.CheckRun>?)__response.CheckRuns,
                initialPage: page ?? 1,
                cancellationToken: cancellationToken);
        }
