...
{
    public partial class EnterpriseTeamOrganizationsClient
    {
        partial void PrepareEnterpriseTeamOrganizationsBulkAddArguments(
        ...
        partial void PrepareEnterpriseTeamOrganizationsBulkAddRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string enterprise,
            string enterpriseTeam,
            global::tryAGI.GitHub.EnterpriseTeamOrganizationsBulkAddRequest request);
        partial void ProcessEnterpriseTeamOrganizationsBulkAddResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEnterpriseTeamOrganizationsBulkAddResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::tryAGI.GitHub.OrganizationSimple>> EnterpriseTeamOrganizationsBulkAddAsync(
            string enterprise,
            string enterpriseTeam,
        ...
        {
            var __response = await EnterpriseTeamOrganizationsBulkAddAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::tryAGI.GitHub.OrganizationSimple>>> EnterpriseTeamOrganizationsBulkAddAsResponseAsync(
            string enterprise,
            string enterpriseTeam,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEnterpriseTeamOrganizationsBulkAddArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEnterpriseTeamOrganizationsBulkAddRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "EnterpriseTeamOrganizationsBulkAddAsync",
                                pathTemplate: "$\"/enterprises/{enterprise}/teams/{enterpriseTeam}/organizations/add\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEnterpriseTeamOrganizationsBulkAddResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEnterpriseTeamOrganizationsBulkAddResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::tryAGI.GitHub.OrganizationSimple>?)global::System.Text.Json.JsonSerializer.Deserialize(__content, typeof(global::System.Collections.Generic.IList<global::tryAGI.GitHub.OrganizationSimple>), JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::tryAGI.GitHub.OrganizationSimple>>(
                            ...
                            else
                            {
                                ...
                                {
                                    __response.EnsureSuccessStatusCode();
                                    var __value = await global::tryAGI.GitHub.AutoSdkPolyfills.ReadFromJsonAsync<global::System.Collections.Generic.IList<global::tryAGI.GitHub.OrganizationSimple>>(__response.Content, JsonSerializerContext, __effectiveCancellationToken).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::tryAGI.GitHub.OrganizationSimple>> EnterpriseTeamOrganizationsBulkAddAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.EnterpriseTeamOrganizationsBulkAddRequest
            {
                OrganizationSlugs = organizationSlugs,
            };

            return await EnterpriseTeamOrganizationsBulkAddAsync(
                enterprise: enterprise,
                enterpriseTeam: enterpriseTeam,
                request: __request,
                requestOptions: requestOptions,
