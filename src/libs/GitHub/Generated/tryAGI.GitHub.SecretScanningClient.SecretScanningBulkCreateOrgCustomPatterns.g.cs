...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareSecretScanningBulkCreateOrgCustomPatternsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string org,
            global::tryAGI.GitHub.SecretScanningBulkCreateOrgCustomPatternsRequest request);
        partial void PrepareSecretScanningBulkCreateOrgCustomPatternsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string org,
            global::tryAGI.GitHub.SecretScanningBulkCreateOrgCustomPatternsRequest request);
        partial void ProcessSecretScanningBulkCreateOrgCustomPatternsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSecretScanningBulkCreateOrgCustomPatternsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.SecretScanningBulkCreateOrgCustomPatternsResponse> SecretScanningBulkCreateOrgCustomPatternsAsync(
            string org,
        ...
        {
            var __response = await SecretScanningBulkCreateOrgCustomPatternsAsResponseAsync(
                org: org,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.SecretScanningBulkCreateOrgCustomPatternsResponse>> SecretScanningBulkCreateOrgCustomPatternsAsResponseAsync(
            string org,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSecretScanningBulkCreateOrgCustomPatternsArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSecretScanningBulkCreateOrgCustomPatternsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SecretScanningBulkCreateOrgCustomPatternsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSecretScanningBulkCreateOrgCustomPatternsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                global::tryAGI.GitHub.SecretScanningBulkCreateOrgCustomPatternsResponse2? __value_422 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_422 = global::tryAGI.GitHub.SecretScanningBulkCreateOrgCustomPatternsResponse2.FromJson(__content_422, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.SecretScanningBulkCreateOrgCustomPatternsResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSecretScanningBulkCreateOrgCustomPatternsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.SecretScanningBulkCreateOrgCustomPatternsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.SecretScanningBulkCreateOrgCustomPatternsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.SecretScanningBulkCreateOrgCustomPatternsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.SecretScanningBulkCreateOrgCustomPatternsResponse> SecretScanningBulkCreateOrgCustomPatternsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.SecretScanningBulkCreateOrgCustomPatternsRequest
            {
                Patterns = patterns,
            };

            return await SecretScanningBulkCreateOrgCustomPatternsAsync(
                org: org,
                request: __request,
                requestOptions: requestOptions,
