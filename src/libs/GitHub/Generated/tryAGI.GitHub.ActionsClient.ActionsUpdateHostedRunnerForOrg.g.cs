...
namespace tryAGI.GitHub
{
    public partial class ActionsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.ActionsHostedRunner> ActionsUpdateHostedRunnerForOrgAsync(
            string org,
            int hostedRunnerId,
        ...
        {
            var __response = await ActionsUpdateHostedRunnerForOrgAsResponseAsync(
                org: org,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.ActionsHostedRunner>> ActionsUpdateHostedRunnerForOrgAsResponseAsync(
            string org,
            int hostedRunnerId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ActionsUpdateHostedRunnerForOrgAsync",
                                pathTemplate: "$\"/orgs/{org}/actions/hosted-runners/{hostedRunnerId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.ActionsHostedRunner.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.ActionsHostedRunner>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.ActionsHostedRunner.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.ActionsHostedRunner> ActionsUpdateHostedRunnerForOrgAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.ActionsUpdateHostedRunnerForOrgRequest
            {
                Name = name,
