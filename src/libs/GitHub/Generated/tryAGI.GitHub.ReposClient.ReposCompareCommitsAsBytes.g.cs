...
namespace tryAGI.GitHub
{
    public partial class ReposClient
    {
        ...
        private static readonly global::tryAGI.GitHub.AutoSDKServer[] s_ReposCompareCommitsAsBytesServers = new global::tryAGI.GitHub.AutoSDKServer[]
        ...
        partial void PrepareReposCompareCommitsAsBytesArguments(
            ...
            ref int? perPage,
            ref string basehead);
        partial void PrepareReposCompareCommitsAsBytesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? perPage,
            string basehead);
        partial void ProcessReposCompareCommitsAsBytesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReposCompareCommitsAsBytesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        public async global::System.Threading.Tasks.Task<byte[]> ReposCompareCommitsAsBytesAsync(
            string owner,
            string repo,
            string basehead,
            int? page = default,
        ...
        {
            var __response = await ReposCompareCommitsAsBytesAsResponseAsync(
                owner: owner,
                repo: repo,
                basehead: basehead,
                page: page,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> ReposCompareCommitsAsBytesAsStreamAsync(
            string owner,
            string repo,
            string basehead,
            int? page = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReposCompareCommitsAsBytesArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::tryAGI.GitHub.PathBuilder(
                                ...
                                servers: s_ReposCompareCommitsAsBytesServers,
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReposCompareCommitsAsBytesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReposCompareCommitsAsBytes",
                                methodName: "ReposCompareCommitsAsBytesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReposCompareCommitsAsBytesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                global::tryAGI.GitHub.ReposCompareCommitsResponse? __value_503 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_503 = global::tryAGI.GitHub.ReposCompareCommitsResponse.FromJson(__content_503, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.ReposCompareCommitsResponse>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            try
                            {
                                ...
                                return new global::tryAGI.GitHub.ResponseStream(__response, __content);
                            }
                            catch (global::System.Exception __ex)
                            {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<byte[]>> ReposCompareCommitsAsBytesAsResponseAsync(
            string owner,
            string repo,
            string basehead,
            int? page = default,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReposCompareCommitsAsBytesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                ...
                                try
                                {
                                    ...
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<byte[]>(
                                        statusCode: __response.StatusCode,
