...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareSecretScanningUpdateRepoCustomPatternArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            ref int patternId,
            global::tryAGI.GitHub.SecretScanningCustomPatternToUpdate request);
        partial void PrepareSecretScanningUpdateRepoCustomPatternRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int patternId,
            global::tryAGI.GitHub.SecretScanningCustomPatternToUpdate request);
        partial void ProcessSecretScanningUpdateRepoCustomPatternResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSecretScanningUpdateRepoCustomPatternResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Update a repository custom pattern<br/>
        /// Updates a secret scanning custom pattern for a repository.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.SecretScanningCustomPattern> SecretScanningUpdateRepoCustomPatternAsync(
            string owner,
            string repo,
            int patternId,
        ...
        {
            var __response = await SecretScanningUpdateRepoCustomPatternAsResponseAsync(
                owner: owner,
                repo: repo,
                patternId: patternId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.SecretScanningCustomPattern>> SecretScanningUpdateRepoCustomPatternAsResponseAsync(
            string owner,
            string repo,
            int patternId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSecretScanningUpdateRepoCustomPatternArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSecretScanningUpdateRepoCustomPatternRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SecretScanningUpdateRepoCustomPatternAsync",
                                pathTemplate: "$\"/repos/{owner}/{repo}/secret-scanning/custom-patterns/{patternId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSecretScanningUpdateRepoCustomPatternResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 412)
                            {
                                ...
                                global::tryAGI.GitHub.BasicError? __value_412 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_412 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_412 = global::tryAGI.GitHub.BasicError.FromJson(__content_412, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_412 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSecretScanningUpdateRepoCustomPatternResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.SecretScanningCustomPattern.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.SecretScanningCustomPattern>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.SecretScanningCustomPattern.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.SecretScanningCustomPattern> SecretScanningUpdateRepoCustomPatternAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.SecretScanningCustomPatternToUpdate
            {
                Pattern = pattern,
            ...
            return await SecretScanningUpdateRepoCustomPatternAsync(
                owner: owner,
                repo: repo,
                patternId: patternId,
                request: __request,
