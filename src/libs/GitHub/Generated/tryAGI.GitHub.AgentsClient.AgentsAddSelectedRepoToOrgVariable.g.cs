...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareAgentsAddSelectedRepoToOrgVariableArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string org,
            ref string name,
            ref int repositoryId);
        partial void PrepareAgentsAddSelectedRepoToOrgVariableRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string org,
            string name,
            int repositoryId);
        partial void ProcessAgentsAddSelectedRepoToOrgVariableResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        /// <summary>
        /// Add selected repository to an organization variable<br/>
        /// Adds a repository to an organization agent variable that is available to selected repositories.<br/>
        ...
        public async global::System.Threading.Tasks.Task AgentsAddSelectedRepoToOrgVariableAsync(
            string org,
            string name,
            int repositoryId,
        ...
        {
            await AgentsAddSelectedRepoToOrgVariableAsResponseAsync(
                org: org,
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse> AgentsAddSelectedRepoToOrgVariableAsResponseAsync(
            string org,
            string name,
            int repositoryId,
            global::tryAGI.GitHub.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAgentsAddSelectedRepoToOrgVariableArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAgentsAddSelectedRepoToOrgVariableRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AgentsAddSelectedRepoToOrgVariableAsync",
                                pathTemplate: "$\"/orgs/{org}/agents/variables/{name}/repositories/{repositoryId}\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAgentsAddSelectedRepoToOrgVariableResponse(
                    httpClient: HttpClient,
