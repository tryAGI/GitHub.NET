...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareIssuesSetIssueFieldValuesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            ref int issueNumber,
            global::tryAGI.GitHub.IssuesSetIssueFieldValuesRequest request);
        partial void PrepareIssuesSetIssueFieldValuesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int issueNumber,
            global::tryAGI.GitHub.IssuesSetIssueFieldValuesRequest request);
        partial void ProcessIssuesSetIssueFieldValuesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessIssuesSetIssueFieldValuesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::tryAGI.GitHub.IssueFieldValue>> IssuesSetIssueFieldValuesAsync(
            string owner,
            string repo,
            int issueNumber,
        ...
        {
            var __response = await IssuesSetIssueFieldValuesAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::tryAGI.GitHub.IssueFieldValue>>> IssuesSetIssueFieldValuesAsResponseAsync(
            string owner,
            string repo,
            int issueNumber,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareIssuesSetIssueFieldValuesArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareIssuesSetIssueFieldValuesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "IssuesSetIssueFieldValues",
                                methodName: "IssuesSetIssueFieldValuesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessIssuesSetIssueFieldValuesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                global::tryAGI.GitHub.IssuesSetIssueFieldValuesResponse? __value_503 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_503 = global::tryAGI.GitHub.IssuesSetIssueFieldValuesResponse.FromJson(__content_503, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.IssuesSetIssueFieldValuesResponse>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessIssuesSetIssueFieldValuesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::tryAGI.GitHub.IssueFieldValue>> IssuesSetIssueFieldValuesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.IssuesSetIssueFieldValuesRequest
            {
                IssueFieldValues = issueFieldValues,
            };

            return await IssuesSetIssueFieldValuesAsync(
                owner: owner,
                repo: repo,
                issueNumber: issueNumber,
                request: __request,
