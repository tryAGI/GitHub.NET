...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareAgentsCreateOrgVariableArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string org,
            global::tryAGI.GitHub.AgentsCreateOrgVariableRequest request);
        partial void PrepareAgentsCreateOrgVariableRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string org,
            global::tryAGI.GitHub.AgentsCreateOrgVariableRequest request);
        partial void ProcessAgentsCreateOrgVariableResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentsCreateOrgVariableResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// Creates an organization agent variable that you can reference in a GitHub Actions workflow.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.EmptyObject> AgentsCreateOrgVariableAsync(
            string org,
        ...
        {
            var __response = await AgentsCreateOrgVariableAsResponseAsync(
                org: org,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.EmptyObject>> AgentsCreateOrgVariableAsResponseAsync(
            string org,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAgentsCreateOrgVariableArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAgentsCreateOrgVariableRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AgentsCreateOrgVariableAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAgentsCreateOrgVariableResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAgentsCreateOrgVariableResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.EmptyObject> AgentsCreateOrgVariableAsync(
            ...
            string name,
            string value,
            global::tryAGI.GitHub.AgentsCreateOrgVariableRequestVisibility visibility,
            global::System.Collections.Generic.IList<int>? selectedRepositoryIds = default,
            global::tryAGI.GitHub.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.AgentsCreateOrgVariableRequest
            {
                Name = name,
                Value = value,
            ...
            return await AgentsCreateOrgVariableAsync(
                org: org,
                request: __request,
                requestOptions: requestOptions,
