...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareActionsGetConcurrencyGroupForRepositoryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            ref string concurrencyGroupName,
            ref int? aheadOfRun,
            ref int? aheadOfJob);
        partial void PrepareActionsGetConcurrencyGroupForRepositoryRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? aheadOfRun,
            int? aheadOfJob);
        partial void ProcessActionsGetConcurrencyGroupForRepositoryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActionsGetConcurrencyGroupForRepositoryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.ConcurrencyGroup> ActionsGetConcurrencyGroupForRepositoryAsync(
            string owner,
            string repo,
            string concurrencyGroupName,
        ...
        {
            var __response = await ActionsGetConcurrencyGroupForRepositoryAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.ConcurrencyGroup>> ActionsGetConcurrencyGroupForRepositoryAsResponseAsync(
            string owner,
            string repo,
            string concurrencyGroupName,
            int? aheadOfRun = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActionsGetConcurrencyGroupForRepositoryArguments(
                httpClient: HttpClient,
                owner: ref owner,
                repo: ref repo,
                concurrencyGroupName: ref concurrencyGroupName,
                aheadOfRun: ref aheadOfRun,
                aheadOfJob: ref aheadOfJob);
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("ahead_of_run", aheadOfRun?.ToString())
                                .AddOptionalParameter("ahead_of_job", aheadOfJob?.ToString())
                                ;
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActionsGetConcurrencyGroupForRepositoryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ActionsGetConcurrencyGroupForRepositoryAsync",
                                pathTemplate: "$\"/repos/{owner}/{repo}/actions/concurrency_groups/{concurrencyGroupName}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActionsGetConcurrencyGroupForRepositoryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActionsGetConcurrencyGroupForRepositoryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.ConcurrencyGroup.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.ConcurrencyGroup>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.ConcurrencyGroup.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
