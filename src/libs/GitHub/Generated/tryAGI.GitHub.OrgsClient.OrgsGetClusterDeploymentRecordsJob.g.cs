...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareOrgsGetClusterDeploymentRecordsJobArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string org,
            ref string cluster,
            ref int jobId);
        partial void PrepareOrgsGetClusterDeploymentRecordsJobRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string org,
            string cluster,
            int jobId);
        partial void ProcessOrgsGetClusterDeploymentRecordsJobResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOrgsGetClusterDeploymentRecordsJobResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.OrgsGetClusterDeploymentRecordsJobResponse> OrgsGetClusterDeploymentRecordsJobAsync(
            string org,
            string cluster,
            int jobId,
        ...
        {
            var __response = await OrgsGetClusterDeploymentRecordsJobAsResponseAsync(
                org: org,
                cluster: cluster,
                jobId: jobId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.OrgsGetClusterDeploymentRecordsJobResponse>> OrgsGetClusterDeploymentRecordsJobAsResponseAsync(
            string org,
            string cluster,
            int jobId,
            global::tryAGI.GitHub.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareOrgsGetClusterDeploymentRecordsJobArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOrgsGetClusterDeploymentRecordsJobRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "OrgsGetClusterDeploymentRecordsJobAsync",
                                pathTemplate: "$\"/orgs/{org}/artifacts/metadata/deployment-record/cluster/{cluster}/jobs/{jobId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOrgsGetClusterDeploymentRecordsJobResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOrgsGetClusterDeploymentRecordsJobResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.OrgsGetClusterDeploymentRecordsJobResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.OrgsGetClusterDeploymentRecordsJobResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.OrgsGetClusterDeploymentRecordsJobResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
