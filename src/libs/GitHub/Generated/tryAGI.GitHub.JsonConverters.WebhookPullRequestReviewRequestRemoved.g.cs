...
{
    /// <inheritdoc />
    public class WebhookPullRequestReviewRequestRemovedJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::tryAGI.GitHub.WebhookPullRequestReviewRequestRemoved>
    {
        /// <inheritdoc />
        public override global::tryAGI.GitHub.WebhookPullRequestReviewRequestRemoved Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("pull_request.stack")) __score0++;
            ...
            if (__jsonProps.Contains("repository.has_pull_requests")) __score0++;
            ...
            if (__jsonProps.Contains("repository.pull_request_creation_policy")) __score0++;
            ...
            if (__jsonProps.Contains("requested_reviewer.user_view_type")) __score0++;
            ...
            if (__jsonProps.Contains("sender.user_view_type")) __score0++;
            var __score1 = 0;
            ...
            if (__jsonProps.Contains("pull_request.stack")) __score1++;
            ...
            if (__jsonProps.Contains("repository.has_pull_requests")) __score1++;
            ...
            if (__jsonProps.Contains("repository.pull_request_creation_policy")) __score1++;
            ...
            if (__jsonProps.Contains("sender.user_view_type")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            if (__score0 > __bestScore) { __bestScore = __score0; __bestIndex = 0; }
            if (__score1 > __bestScore) { __bestScore = __score1; __bestIndex = 1; }

            global::tryAGI.GitHub.WebhookPullRequestReviewRequestRemovedVariant1? webhookPullRequestReviewRequestRemovedVariant1 = default;
            global::tryAGI.GitHub.WebhookPullRequestReviewRequestRemovedVariant2? webhookPullRequestReviewRequestRemovedVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.GitHub.WebhookPullRequestReviewRequestRemovedVariant1), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.GitHub.WebhookPullRequestReviewRequestRemovedVariant1> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::tryAGI.GitHub.WebhookPullRequestReviewRequestRemovedVariant1).Name}");
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::tryAGI.GitHub.WebhookPullRequestReviewRequestRemovedVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::tryAGI.GitHub.WebhookPullRequestReviewRequestRemovedVariant2> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::tryAGI.GitHub.WebhookPullRequestReviewRequestRemovedVariant2).Name}");
            ...
            var __value = new global::tryAGI.GitHub.WebhookPullRequestReviewRequestRemoved(
        ...
        public override void Write(
            ...
            global::tryAGI.GitHub.WebhookPullRequestReviewRequestRemoved value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
