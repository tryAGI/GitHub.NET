...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareBillingGetAllBudgetsOrgArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string org,
            ref int? page,
            ref int? perPage,
            ref global::tryAGI.GitHub.BillingGetAllBudgetsOrgScope? scope,
            ref string? user);
        partial void PrepareBillingGetAllBudgetsOrgRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string org,
            int? page,
            int? perPage,
            global::tryAGI.GitHub.BillingGetAllBudgetsOrgScope? scope,
            string? user);
        partial void ProcessBillingGetAllBudgetsOrgResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBillingGetAllBudgetsOrgResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.GetAllBudgets> BillingGetAllBudgetsOrgAsync(
            string org,
            int? page = default,
            int? perPage = default,
        ...
        {
            var __response = await BillingGetAllBudgetsOrgAsResponseAsync(
                org: org,
                page: page,
                perPage: perPage,
                scope: scope,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.GetAllBudgets>> BillingGetAllBudgetsOrgAsResponseAsync(
            string org,
            int? page = default,
            int? perPage = default,
            global::tryAGI.GitHub.BillingGetAllBudgetsOrgScope? scope = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBillingGetAllBudgetsOrgArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBillingGetAllBudgetsOrgRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BillingGetAllBudgetsOrgAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBillingGetAllBudgetsOrgResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBillingGetAllBudgetsOrgResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.GetAllBudgets.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.GetAllBudgets>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.GetAllBudgets.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::tryAGI.GitHub.Budget> BillingGetAllBudgetsOrgAutoPagingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::tryAGI.GitHub.AutoSDKPager.OffsetAsync<global::tryAGI.GitHub.GetAllBudgets, global::tryAGI.GitHub.Budget>(
                fetchPage: (__page, __ct) => BillingGetAllBudgetsOrgAsync(
                    org: org,
                    page: __page,
                    perPage: perPage,
                    scope: scope,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::tryAGI.GitHub.Budget>?)__response.Budgets,
                hasMore: static __response => __response is not null && (__response.HasNextPage ?? false),
                initialPage: page ?? 1,
                cancellationToken: cancellationToken);
        }
