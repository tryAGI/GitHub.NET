...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareDependabotUpdateRepositoryAccessForEnterpriseArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string enterprise,
            global::tryAGI.GitHub.DependabotUpdateRepositoryAccessForEnterpriseRequest request);
        partial void PrepareDependabotUpdateRepositoryAccessForEnterpriseRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string enterprise,
            global::tryAGI.GitHub.DependabotUpdateRepositoryAccessForEnterpriseRequest request);
        partial void ProcessDependabotUpdateRepositoryAccessForEnterpriseResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task DependabotUpdateRepositoryAccessForEnterpriseAsync(
            string enterprise,
        ...
        {
            await DependabotUpdateRepositoryAccessForEnterpriseAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse> DependabotUpdateRepositoryAccessForEnterpriseAsResponseAsync(
            string enterprise,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDependabotUpdateRepositoryAccessForEnterpriseArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDependabotUpdateRepositoryAccessForEnterpriseRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DependabotUpdateRepositoryAccessForEnterpriseAsync",
                                pathTemplate: "$\"/enterprises/{enterprise}/dependabot/repository-access\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDependabotUpdateRepositoryAccessForEnterpriseResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task DependabotUpdateRepositoryAccessForEnterpriseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.DependabotUpdateRepositoryAccessForEnterpriseRequest
            {
                RepositoryIdsToAdd = repositoryIdsToAdd,
                RepositoryIdsToRemove = repositoryIdsToRemove,
            };

            await DependabotUpdateRepositoryAccessForEnterpriseAsync(
                enterprise: enterprise,
                request: __request,
                requestOptions: requestOptions,
