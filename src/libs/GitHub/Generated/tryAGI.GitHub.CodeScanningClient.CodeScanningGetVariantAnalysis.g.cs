...
namespace tryAGI.GitHub
{
    public partial class CodeScanningClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.CodeScanningVariantAnalysis> CodeScanningGetVariantAnalysisAsync(
            string owner,
            string repo,
            int codeqlVariantAnalysisId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.CodeScanningVariantAnalysis>> CodeScanningGetVariantAnalysisAsResponseAsync(
            string owner,
            string repo,
            int codeqlVariantAnalysisId,
            global::tryAGI.GitHub.AutoSDKRequestOptions? requestOptions = default,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                global::tryAGI.GitHub.CodeScanningGetVariantAnalysisResponse? __value_503 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_503 = global::tryAGI.GitHub.CodeScanningGetVariantAnalysisResponse.FromJson(__content_503, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.CodeScanningGetVariantAnalysisResponse>.Create(
                                    statusCode: __response.StatusCode,
