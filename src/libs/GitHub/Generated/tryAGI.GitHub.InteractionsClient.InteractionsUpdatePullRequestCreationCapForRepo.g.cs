...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareInteractionsUpdatePullRequestCreationCapForRepoArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForRepoRequest request);
        partial void PrepareInteractionsUpdatePullRequestCreationCapForRepoRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string owner,
            string repo,
            global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForRepoRequest request);
        partial void ProcessInteractionsUpdatePullRequestCreationCapForRepoResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessInteractionsUpdatePullRequestCreationCapForRepoResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForRepoResponse> InteractionsUpdatePullRequestCreationCapForRepoAsync(
            string owner,
            string repo,
        ...
        {
            var __response = await InteractionsUpdatePullRequestCreationCapForRepoAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForRepoResponse>> InteractionsUpdatePullRequestCreationCapForRepoAsResponseAsync(
            string owner,
            string repo,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareInteractionsUpdatePullRequestCreationCapForRepoArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareInteractionsUpdatePullRequestCreationCapForRepoRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "InteractionsUpdatePullRequestCreationCapForRepoAsync",
                                pathTemplate: "$\"/repos/{owner}/{repo}/interaction-limits/pulls/creation-cap\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessInteractionsUpdatePullRequestCreationCapForRepoResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 405)
                            {
                                ...
                                global::tryAGI.GitHub.BasicError? __value_405 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_405 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_405 = global::tryAGI.GitHub.BasicError.FromJson(__content_405, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_405 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessInteractionsUpdatePullRequestCreationCapForRepoResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForRepoResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForRepoResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForRepoResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForRepoResponse> InteractionsUpdatePullRequestCreationCapForRepoAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.InteractionsUpdatePullRequestCreationCapForRepoRequest
            {
                Enabled = enabled,
                MaxOpenPullRequests = maxOpenPullRequests,
            };

            return await InteractionsUpdatePullRequestCreationCapForRepoAsync(
                owner: owner,
                repo: repo,
                request: __request,
                requestOptions: requestOptions,
