...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareActionsListConcurrencyGroupsForRepositoryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            ref int? perPage,
            ref string? after);
        partial void PrepareActionsListConcurrencyGroupsForRepositoryRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? perPage,
            string? after);
        partial void ProcessActionsListConcurrencyGroupsForRepositoryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActionsListConcurrencyGroupsForRepositoryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List concurrency groups for a repository<br/>
        /// Lists the active concurrency groups for a repository.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.ConcurrencyGroupList> ActionsListConcurrencyGroupsForRepositoryAsync(
            string owner,
            string repo,
            int? perPage = default,
        ...
        {
            var __response = await ActionsListConcurrencyGroupsForRepositoryAsResponseAsync(
                owner: owner,
                repo: repo,
                perPage: perPage,
                after: after,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.ConcurrencyGroupList>> ActionsListConcurrencyGroupsForRepositoryAsResponseAsync(
            string owner,
            string repo,
            int? perPage = default,
            string? after = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActionsListConcurrencyGroupsForRepositoryArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActionsListConcurrencyGroupsForRepositoryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ActionsListConcurrencyGroupsForRepositoryAsync",
                                pathTemplate: "$\"/repos/{owner}/{repo}/actions/concurrency_groups\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActionsListConcurrencyGroupsForRepositoryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActionsListConcurrencyGroupsForRepositoryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.ConcurrencyGroupList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.ConcurrencyGroupList>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.ConcurrencyGroupList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
