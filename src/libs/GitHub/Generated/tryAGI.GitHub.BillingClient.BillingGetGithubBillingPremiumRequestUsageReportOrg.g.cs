...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareBillingGetGithubBillingPremiumRequestUsageReportOrgArguments(
            ...
            ref string? model,
            ref string? product);
        partial void PrepareBillingGetGithubBillingPremiumRequestUsageReportOrgRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? model,
            string? product);
        partial void ProcessBillingGetGithubBillingPremiumRequestUsageReportOrgResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBillingGetGithubBillingPremiumRequestUsageReportOrgResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.BillingPremiumRequestUsageReportOrg> BillingGetGithubBillingPremiumRequestUsageReportOrgAsync(
            string org,
            int? year = default,
            int? month = default,
            int? day = default,
        ...
        {
            var __response = await BillingGetGithubBillingPremiumRequestUsageReportOrgAsResponseAsync(
                org: org,
                year: year,
                month: month,
                day: day,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.BillingPremiumRequestUsageReportOrg>> BillingGetGithubBillingPremiumRequestUsageReportOrgAsResponseAsync(
            string org,
            int? year = default,
            int? month = default,
            int? day = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBillingGetGithubBillingPremiumRequestUsageReportOrgArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBillingGetGithubBillingPremiumRequestUsageReportOrgRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BillingGetGithubBillingPremiumRequestUsageReportOrgAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBillingGetGithubBillingPremiumRequestUsageReportOrgResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                global::tryAGI.GitHub.BillingGetGithubBillingPremiumRequestUsageReportOrgResponse? __value_503 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_503 = global::tryAGI.GitHub.BillingGetGithubBillingPremiumRequestUsageReportOrgResponse.FromJson(__content_503, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.BillingGetGithubBillingPremiumRequestUsageReportOrgResponse>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBillingGetGithubBillingPremiumRequestUsageReportOrgResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.BillingPremiumRequestUsageReportOrg.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.BillingPremiumRequestUsageReportOrg>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.BillingPremiumRequestUsageReportOrg.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
