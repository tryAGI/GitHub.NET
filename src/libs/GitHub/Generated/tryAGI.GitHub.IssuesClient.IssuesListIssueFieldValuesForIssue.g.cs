...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareIssuesListIssueFieldValuesForIssueArguments(
            ...
            ref int? perPage,
            ref int? page);
        partial void PrepareIssuesListIssueFieldValuesForIssueRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? perPage,
            int? page);
        partial void ProcessIssuesListIssueFieldValuesForIssueResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessIssuesListIssueFieldValuesForIssueResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List issue field values for an issue<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::tryAGI.GitHub.IssueFieldValue>> IssuesListIssueFieldValuesForIssueAsync(
            string owner,
            string repo,
            int issueNumber,
            int? perPage = default,
        ...
        {
            var __response = await IssuesListIssueFieldValuesForIssueAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::tryAGI.GitHub.IssueFieldValue>>> IssuesListIssueFieldValuesForIssueAsResponseAsync(
            string owner,
            string repo,
            int issueNumber,
            int? perPage = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareIssuesListIssueFieldValuesForIssueArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareIssuesListIssueFieldValuesForIssueRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "IssuesListIssueFieldValuesForIssueAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessIssuesListIssueFieldValuesForIssueResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 301)
                            {
                                ...
                                global::tryAGI.GitHub.BasicError? __value_301 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_301 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_301 = global::tryAGI.GitHub.BasicError.FromJson(__content_301, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_301 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if ((int)__response.StatusCode == 410)
                            {
                                ...
                                global::tryAGI.GitHub.BasicError? __value_410 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_410 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_410 = global::tryAGI.GitHub.BasicError.FromJson(__content_410, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_410 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessIssuesListIssueFieldValuesForIssueResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
