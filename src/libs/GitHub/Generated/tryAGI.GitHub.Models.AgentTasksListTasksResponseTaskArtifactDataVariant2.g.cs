...
namespace tryAGI.GitHub
{
    ...
    public sealed partial class AgentTasksListTasksResponseTaskArtifactDataVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentTasksListTasksResponseTaskArtifactDataVariant2" /> class.
        /// </summary>
        /// <param name="headRef">
        /// Head branch name
        /// </param>
...
#endif
        public AgentTasksListTasksResponseTaskArtifactDataVariant2(
            string headRef,
            string baseRef)
        {
