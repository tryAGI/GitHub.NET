...
namespace tryAGI.GitHub
{
    public partial class ReposClient
    {
        ...
        private static readonly global::tryAGI.GitHub.AutoSDKServer[] s_ReposDeleteFileServers = new global::tryAGI.GitHub.AutoSDKServer[]
        ...
        partial void PrepareReposDeleteFileArguments(
            ...
            ref string repo,
            ref string path,
            global::tryAGI.GitHub.ReposDeleteFileRequest request);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.FileCommit> ReposDeleteFileAsync(
            string owner,
            string repo,
            string path,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.FileCommit>> ReposDeleteFileAsResponseAsync(
            string owner,
            string repo,
            string path,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                global::tryAGI.GitHub.ReposDeleteFileResponse? __value_503 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_503 = global::tryAGI.GitHub.ReposDeleteFileResponse.FromJson(__content_503, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::tryAGI.GitHub.ApiException<global::tryAGI.GitHub.ReposDeleteFileResponse>.Create(
                                    statusCode: __response.StatusCode,
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.FileCommit> ReposDeleteFileAsync(
            ...
            global::tryAGI.GitHub.ReposDeleteFileRequestCommitter? committer = default,
            global::tryAGI.GitHub.ReposDeleteFileRequestAuthor? author = default,
            global::tryAGI.GitHub.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.ReposDeleteFileRequest
            {
                Message = message,
                Sha = sha,
                Branch = branch,
