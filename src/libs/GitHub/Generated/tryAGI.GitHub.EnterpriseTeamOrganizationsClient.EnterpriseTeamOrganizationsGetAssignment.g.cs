...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareEnterpriseTeamOrganizationsGetAssignmentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string enterprise,
            ref string enterpriseTeam,
            ref string org);
        partial void PrepareEnterpriseTeamOrganizationsGetAssignmentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string enterprise,
            string enterpriseTeam,
            string org);
        partial void ProcessEnterpriseTeamOrganizationsGetAssignmentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEnterpriseTeamOrganizationsGetAssignmentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.OrganizationSimple> EnterpriseTeamOrganizationsGetAssignmentAsync(
            string enterprise,
            string enterpriseTeam,
            string org,
        ...
        {
            var __response = await EnterpriseTeamOrganizationsGetAssignmentAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.OrganizationSimple>> EnterpriseTeamOrganizationsGetAssignmentAsResponseAsync(
            string enterprise,
            string enterpriseTeam,
            string org,
            global::tryAGI.GitHub.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEnterpriseTeamOrganizationsGetAssignmentArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEnterpriseTeamOrganizationsGetAssignmentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "EnterpriseTeamOrganizationsGetAssignmentAsync",
                                pathTemplate: "$\"/enterprises/{enterprise}/teams/{enterpriseTeam}/organizations/{org}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEnterpriseTeamOrganizationsGetAssignmentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEnterpriseTeamOrganizationsGetAssignmentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.OrganizationSimple.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.OrganizationSimple>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.OrganizationSimple.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
