...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareAgentsCreateOrUpdateRepoSecretArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            ref string secretName,
            global::tryAGI.GitHub.AgentsCreateOrUpdateRepoSecretRequest request);
        partial void PrepareAgentsCreateOrUpdateRepoSecretRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string secretName,
            global::tryAGI.GitHub.AgentsCreateOrUpdateRepoSecretRequest request);
        partial void ProcessAgentsCreateOrUpdateRepoSecretResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentsCreateOrUpdateRepoSecretResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.EmptyObject> AgentsCreateOrUpdateRepoSecretAsync(
            string owner,
            string repo,
            string secretName,
        ...
        {
            var __response = await AgentsCreateOrUpdateRepoSecretAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.EmptyObject>> AgentsCreateOrUpdateRepoSecretAsResponseAsync(
            string owner,
            string repo,
            string secretName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAgentsCreateOrUpdateRepoSecretArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAgentsCreateOrUpdateRepoSecretRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AgentsCreateOrUpdateRepoSecret",
                                methodName: "AgentsCreateOrUpdateRepoSecretAsync",
                                pathTemplate: "$\"/repos/{owner}/{repo}/agents/secrets/{secretName}\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAgentsCreateOrUpdateRepoSecretResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAgentsCreateOrUpdateRepoSecretResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.EmptyObject> AgentsCreateOrUpdateRepoSecretAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.AgentsCreateOrUpdateRepoSecretRequest
            {
                EncryptedValue = encryptedValue,
                KeyId = keyId,
            };

            return await AgentsCreateOrUpdateRepoSecretAsync(
                owner: owner,
                repo: repo,
                secretName: secretName,
                request: __request,
