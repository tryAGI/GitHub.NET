...
namespace tryAGI.GitHub
{
    ...
    {
        partial void PrepareOrgsSetClusterDeploymentRecordsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string org,
            ref string cluster,
            global::tryAGI.GitHub.OrgsSetClusterDeploymentRecordsRequest request);
        partial void PrepareOrgsSetClusterDeploymentRecordsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string org,
            string cluster,
            global::tryAGI.GitHub.OrgsSetClusterDeploymentRecordsRequest request);
        partial void ProcessOrgsSetClusterDeploymentRecordsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOrgsSetClusterDeploymentRecordsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.OrgsSetClusterDeploymentRecordsResponse> OrgsSetClusterDeploymentRecordsAsync(
            string org,
            string cluster,
        ...
        {
            var __response = await OrgsSetClusterDeploymentRecordsAsResponseAsync(
                org: org,
                cluster: cluster,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::tryAGI.GitHub.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.OrgsSetClusterDeploymentRecordsResponse>> OrgsSetClusterDeploymentRecordsAsResponseAsync(
            string org,
            string cluster,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareOrgsSetClusterDeploymentRecordsArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOrgsSetClusterDeploymentRecordsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "OrgsSetClusterDeploymentRecordsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOrgsSetClusterDeploymentRecordsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::tryAGI.GitHub.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOrgsSetClusterDeploymentRecordsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::tryAGI.GitHub.OrgsSetClusterDeploymentRecordsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::tryAGI.GitHub.AutoSDKHttpResponse<global::tryAGI.GitHub.OrgsSetClusterDeploymentRecordsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::tryAGI.GitHub.OrgsSetClusterDeploymentRecordsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::tryAGI.GitHub.OrgsSetClusterDeploymentRecordsResponse> OrgsSetClusterDeploymentRecordsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::tryAGI.GitHub.OrgsSetClusterDeploymentRecordsRequest
            {
            ...
            return await OrgsSetClusterDeploymentRecordsAsync(
                org: org,
                cluster: cluster,
                request: __request,
                requestOptions: requestOptions,
