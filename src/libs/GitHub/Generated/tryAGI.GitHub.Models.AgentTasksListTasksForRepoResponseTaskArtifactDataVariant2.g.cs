...
namespace tryAGI.GitHub
{
    ...
    public sealed partial class AgentTasksListTasksForRepoResponseTaskArtifactDataVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentTasksListTasksForRepoResponseTaskArtifactDataVariant2" /> class.
        /// </summary>
        /// <param name="headRef">
        /// Head branch name
        /// </param>
...
#endif
        public AgentTasksListTasksForRepoResponseTaskArtifactDataVariant2(
            string headRef,
            string baseRef)
        {
